...
\titlerunning{Robotic Validation of an Inter-disciplinary Generic Model of Self-regulated Division of Labour\\ in Social Systems}
...
We call this variable affinity of a robot $i$  to that task $j$ as its sensitization $k_{j}^{i}$.
...
\bibliographystyle{splncs} % basic style, author-year citations
